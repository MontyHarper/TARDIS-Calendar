                ...
                // View on top of background is arranged into three groups; label bar, timeline for events, and a box showing current information. Grouping is just conceptual. Individual elements are placed exactly.
                    ...
                    // Group {
                        ...
                        Text(timeSpanLabel(span))
                            ...
                            .fontWeight(.heavy)
                            .position(x: screen.size.width * 0.5, y: yOfLabelBar * screen.size.height - 25.0)
                        
                    //} // End of Label Bar Group
                    ...
                    // Group {
                        ...
                        // Current Date Label
                        DateLabel()
                            .position(x: 0.5 * screen.size.width, y: yOfInfoBox * screen.size.height)
